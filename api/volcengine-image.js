...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Seedream 5.0: size 必须 >= 3,686,400 像素，格式为 WIDTHxHEIGHT 或 2K/3K/4K
    const sizeMap = { "1:1": "2000x2000", "4:3": "2400x1800", "9:16": "1440x2560" };
    const imageSize = sizeMap[size || "1:1"] || "2000x2000";
